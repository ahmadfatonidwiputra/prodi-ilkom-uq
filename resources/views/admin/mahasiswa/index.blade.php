...
@section('content')
<div class="d-flex justify-content-between align-items-center mb-3"><h2 class="h4 mb-0">Data Prestasi Mahasiswa</h2><a href="{{ route('admin.mahasiswa.create') }}" class="btn btn-primary">+ Tambah Data</a></div>
@if (session('success')) <div class="alert alert-success">{{ session('success') }}</div> @endif
<div class="card border-0 shadow-sm bg-white"><div class="table-responsive"><table class="table align-middle mb-0"><thead class="table-light"><tr><th>Nama</th><th>NIM</th><th>Angkatan</th><th>Prestasi</th><th>Status</th><th class="text-end">Aksi</th></tr></thead><tbody>
...
@empty<tr><td colspan="6" class="text-center text-muted">Belum ada data prestasi mahasiswa.</td></tr>@endforelse
</tbody></table></div></div>
